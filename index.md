...
address: "Discovery Building, Orchard View Room, 330 N Orchard St, Madison, WI 53715"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
instructor: ["Sarah Stevens", "Divya Jain", "Hannah Olson-Williams", "Grace Cagle", "Jean-Yves Sgro", "Meg Taylor", "Ralf Kotula", "Chris Endemann"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Rene Welch", "Chris Kirby", "Heather Shimon", "Grace Cagle", "Peter Cruz Parrilla", "Aurod Ounsinegad", "Hannah Olson-Williams", "Ralf Kotula", "Chris Endemann"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2024-06-17-uwmadison-dc # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite: "887910392887"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
